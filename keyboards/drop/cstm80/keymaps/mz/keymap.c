...
void set_unicode_input_mode(uint8_t UNICODE_MODE_WINCOMPOSE);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_tkl_f13_ansi(
        ...
        KC_CAPS, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(1),   MO(2),   KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_tkl_f13_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______,
        _______, _______, _______, UM(SHWA),_______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______,
    ...
    [2] = LAYOUT_tkl_f13_ansi(
        ...
        _______, RM_TOGG, RM_VALU, RM_SPDU, RM_HUEU, RM_SATU, _______, UC_WINC, UM(SHWA), _______, _______, _______, _______, _______,    _______, _______, _______,
        _______, RM_NEXT, RM_VALD, RM_SPDD, RM_HUED, RM_SATD, _______, _______, _______, _______, _______, _______,          QK_MAKE,
